...
public class T265LocalizerRR implements Localizer {
    ...
    public T265LocalizerRR(HardwareMap hardwareMap, boolean resetPos) {
        ...
        if (slamra == null) {
            slamra = new T265Camera(new Transform2d(new Translation2d(0,0), new Rotation2d(Math.toRadians(90))), 0, hardwareMap.appContext);
        ...
        try {
            ...
            if (resetPos) {
                slamra.setPose(new com.arcrobotics.ftclib.geometry.Pose2d(0,0, new Rotation2d(90)));
            }
        }
