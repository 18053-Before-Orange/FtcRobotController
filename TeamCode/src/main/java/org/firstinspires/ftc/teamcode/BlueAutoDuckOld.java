...
@Autonomous
@Disabled
public class BlueAutoDuckOld extends LinearOpMode
{
    OpenCvWebcam webcam;
    ...
    public void runOpMode()
    {
        ...
        Trajectory traj2 = drive.trajectoryBuilder(traj1.end().plus(new Pose2d(0,0, Math.toRadians(90))))
                .lineTo(new Vector2d(-54, 58))
                .build();

        Trajectory traj2_1 = drive.trajectoryBuilder(traj2.end().plus(new Pose2d(0,0, Math.toRadians(-90))))
                .lineTo(new Vector2d(-56, 58))
                .build();

        Trajectory traj3 = drive.trajectoryBuilder(traj2_1.end())
        ...
        lift.runToPosition(DUCK_SPIN_POSITION);
        duck.spin(-0.25);
        sleep(4000);
        duck.spinStop();
        lift.runToPosition(DUCK_APPROACH_POSITION);
